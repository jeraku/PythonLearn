''' Write a Python program that acts as a simple receipt generator for a store. 
Your program should: Ask the user to enter the name and price of 3 items.
 Calculate the subtotal, tax (10% of subtotal),and total. Display a formatted receipt 
